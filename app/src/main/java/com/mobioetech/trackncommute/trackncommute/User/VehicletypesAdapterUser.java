...
public class VehicletypesAdapterUser extends RecyclerView.Adapter<VehicletypesAdapterUser.ViewHolder> {

    private ArrayList<VehicleCategories> vehicle_categories;
    private Context context;
    private static final String LOG = "vehicletypesAdapter";

    public VehicletypesAdapterUser(Context context, ArrayList<VehicleCategories> vehicle_categories) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = null;
                switch(position){
                    case 0:intent = new Intent(context,NearbyAutosMapActivity.class);
